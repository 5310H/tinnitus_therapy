...
(btnText.includes('sometimes') ? 2 : 0);
          ...
          function checkAIState() {
              ...
              if (audit.isAILocked) {
                  ...
                  responseBox.innerHTML = `<div class="chat-bubble ai-bubble" style="border-color: #ff9800;">ðŸ”’ 
...
var(--accent); text-decoration: underline;">Dashboard</a> to enter your PIN and unlock AI assistance.</div>`;
              } else if (!audit.isAIConfigured) {
                  responseBox.style.display = 'flex';
                  responseBox.innerHTML = `<div class="chat-bubble ai-bubble" style="border-color: #ef5350;">âšï¸ 
